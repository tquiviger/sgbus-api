...
if __name__ == "__main__":
    ...
    producer = KafkaProducer(bootstrap_servers=apiconfig.api["kafkaUrl"] + ':' + str(apiconfig.api["kafkaPort"]),
    ...
    while (count < 6000):
        ...
        for bus_station in jsonObj:
            ...
            url2 = 'http://datamall2.mytransport.sg/ltaodataservice/BusArrival?BusStopID=' + bus_station[
                "BusStopCode"] + '&SST=True'
                    ...
                    if arrival2:
                        ...
                        if arrival3:
                            ...
                            if delta3 < 0:
                                delta3 = 0
                body = str(
                    _now.strftime('%Y%m%d%H%M%S')) + '|' + bus_stop_code + '|' + service_no + '|' + status + '|' + str(
                    delta1) + '|' + load1 + '|' + str(delta2) + '|' + load2 + '|' + str(delta3) + '|' + load3
